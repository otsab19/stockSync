  ...
  return (
    <PageShell className="py-8 lg:py-10">
      ...
      <section className="grid gap-4 lg:grid-cols-[1.4fr_1fr]">
        <Card className="border-border bg-[linear-gradient(145deg,rgba(16,185,129,0.08),rgba(59,130,246,0.06),transparent_72%)]">
          <CardHeader>
            ...
            {quickLinks.map((link) => {
              ...
              return (
                <Link
                  key={link.href}
                  href={link.href}
                  className="flex items-start gap-3 rounded-lg border border-border bg-card p-4 card-shadow transition-colors hover:bg-muted/40"
                >
                  <span className="mt-0.5 flex size-10 shrink-0 items-center justify-center rounded-xl border border-border bg-background/40">
